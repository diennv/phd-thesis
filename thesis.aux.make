...
\@writefile{loa}{\addvspace {10\p@ }}
\@writefile{loa}{\addvspace {10\p@ }}
\@writefile{loa}{\contentsline {algocf}{\numberline {1}{\ignorespaces  IoU calculation for two bounding boxes coordinates.\relax }}{34}{algocf.1}}
...
\@writefile{lof}{\contentsline {figure}{\numberline {3.1}{\ignorespaces  Our proposed system.\relax }}{25}{figure.caption.26}}
...
\@writefile{lof}{\contentsline {figure}{\numberline {4.4}{\ignorespaces The comparision of moving objects detection by the proposed method in different cases: (a, b, c, d) for human walking; (e, f, g, h) for human running; (i, j, k, l) when test with a far distance of camera.\relax }}{41}{figure.caption.40}}
...
\@writefile{lot}{\contentsline {table}{\numberline {4.3}{\ignorespaces Testbed: video sequence grouth-truth motion time.\relax }}{39}{table.caption.38}}
\@writefile{lot}{\contentsline {table}{\numberline {4.4}{\ignorespaces The average IoU calculation of the moving object detection in compressed-domain in different cases.\relax }}{41}{table.caption.41}}
\@writefile{lot}{\contentsline {table}{\numberline {4.5}{\ignorespaces Per-Frame Interference Time. Values are expressed in miliseconds (ms) and frame per second(FPS).\relax }}{42}{table.caption.42}}
\@writefile{lot}{\contentsline {table}{\numberline {4.6}{\ignorespaces The \IeC {\textquotedblleft }average computing resources\IeC {\textquotedblright } comparision between the \IeC {\textquotedblleft }conventional method and the proposed method\IeC {\textquotedblright } with $\alpha $=0.25\relax }}{47}{table.caption.50}}
\@writefile{lot}{\contentsline {table}{\numberline {4.7}{\ignorespaces The \IeC {\textquotedblleft }average computing resources\IeC {\textquotedblright } comparision the \IeC {\textquotedblleft }conventional method and the proposed method\IeC {\textquotedblright } with $\alpha $=0.5\relax }}{47}{table.caption.51}}
\@writefile{lot}{\contentsline {table}{\numberline {4.8}{\ignorespaces The \IeC {\textquotedblleft }average computing resources\IeC {\textquotedblright } comparision the \IeC {\textquotedblleft }conventional method and the proposed method\IeC {\textquotedblright } with $\alpha $=0.7\relax }}{48}{table.caption.52}}
...
\@writefile{toc}{\contentsline {section}{\numberline {4.1}The low-compelxity algorithm of moving object detection in Video Compressed Domain}{40}{section.4.1}}
\@writefile{toc}{\contentsline {section}{\numberline {4.2}Performance Evaluation Results}{44}{section.4.2}}
...
\@writefile{toc}{\contentsline {subsection}{\numberline {4.2.1}Computing Resources Consumption}{44}{subsection.4.2.1}}
\@writefile{toc}{\contentsline {subsubsection}{Video Codec}{10}{section*.12}}
\@writefile{toc}{\contentsline {subsubsection}{Video Coding Motion Vectors and Blocked-based Motion Estimation}{11}{section*.14}}
