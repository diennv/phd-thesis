...
\section{The low-compelxity algorithm of moving object detection in Video Compressed Domain}
...
\hline
\multirow{2}{*}{\textit{\begin{tabular}[c]{@{}c@{}}Test\\  Sequence\end{tabular}}} & \multicolumn{2}{c|}{\textit{Scenario}} & \multirow{2}{*}{\textit{IoU Average}} \\ \cline{2-3}
...
%“Camera source node where the camera node periodically generates video tasks”
...
\subfloat[]
{
    \includegraphics[width=0.5\linewidth]{Figures/gpu_0_5.jpg}
}
\subfloat[]
{
    \includegraphics[width=0.5\linewidth]{Figures/gpu_0_25.jpg}
}\\
\subfloat[]
{
    \includegraphics[width=0.5\linewidth]{Figures/gpu_0_75.jpg}
}
\subfloat[]
{
    \includegraphics[width=0.5\linewidth]{Figures/ground-truth.png}
}
...
\begin{figure*}
\centering
\includegraphics[scale=0.7]{Figures/download_throughput.png}
\caption{Download Throughput with different alpha threshold.}
\label{fig:download_throughput}
\end{figure*}
\begin{table}[]
\centering
\caption{The “average computing resources” comparision between the “conventional method and the proposed method” with $\alpha$=0.25}
\label{tab:computingresource0}
\begin{tabular}{|c|c|c|c|}
\hline
\textbf{“Computing Resources”}                                         & \textbf{“Conventional Method”} & \textbf{“Proposed Method”} & \textbf{“Performance Ratio”} \\ \hline
GPU Usage (\%)                                                  & 65.60                      & 30                    & 0.45                       \\ \hline
CPU Usage (\%)                                                  & 50.25                        & 39.64                     & 0.51                       \\ \hline
\begin{tabular}[c]{@{}c@{}}Download Throughput\\ (Kbps)\end{tabular} & 4027                         & 1509                   & 0.35                       \\ \hline
\end{tabular}
\end{table}

\begin{table}[]
\centering
\caption{The “average computing resources” comparision the “conventional method and the proposed method” with $\alpha$=0.5}
\label{tab:computingresource1}
\begin{tabular}{|c|c|c|c|}
\hline
\textbf{“Computing Resources”}                                         & \textbf{“Conventional Method”} & \textbf{“Proposed Method”} & \textbf{“Performance Ratio”} \\ \hline
GPU Usage (\%)                                                  & 65.60                        & 22.3                    & 0.34                       \\ \hline
CPU Usage (\%)                                                  & 50.25                        & 34                    & 0.45                       \\ \hline
\begin{tabular}[c]{@{}c@{}}Download Throughput\\ (Kbps)\end{tabular} & 4027                         & 1478                  & 0.36                       \\ \hline
\end{tabular}
\end{table}

\begin{table}[]
\centering
\caption{The “average computing resources” comparision the “conventional method and the proposed method” with $\alpha$=0.7}
\label{tab:computingresource2}
\begin{tabular}{|c|c|c|c|}
\hline
\textbf{“Computing Resources”}                                         & \textbf{“Conventional Method”} & \textbf{“Proposed Method”} & \textbf{“Performance Ratio”} \\ \hline
GPU Usage (\%)                                                  & 65.60                        & 33.73                    & 0.33                       \\ \hline
CPU Usage (\%)                                                  & 50.25                        & 25.9                     & 0.43                       \\ \hline
\begin{tabular}[c]{@{}c@{}}Download Throughput\\ (Kbps)\end{tabular} & 4027                         & 1808.2                   & 0.35                       \\ \hline
\end{tabular}
\end{table}


We demonstrate the application of  intrusion detection. The computing resources, such as CPU, GPU usage, and network traffic download throughput, was monitored and logged and shown in Figure \ref{fig:sysdesign}. For performance comparison, the evaluated results are compared to that of the conventional method, which did not use edge node as shown in Figure \ref{fig:overall}. The results show that both methods achieve the same accuracy in terms of event alert when humans entered the restricted area. The demonstration's record video of both these methods are uploaded to \cite{convential}, \cite{proposed}. In figure \ref{fig:gpu}, We measured the GPU computing resource of both the conventional
...
In order to evaluate the efficiency of the proposed method, we
