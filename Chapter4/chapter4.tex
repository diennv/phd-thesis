...
GPU Utilization (\%)                                                  & 65.61                        & 30                    & 0.45                       \\ \hline
CPU Utilization (\%)                                                  & 50.24                        & 39.64                     & 0.51                       \\ \hline
\begin{tabular}[c]{@{}c@{}}Download Throughput\\ (Kbps)\end{tabular} & 4028                         & 1509                   & 0.35                       \\ \hline
\end{tabular}
\end{table}
...
\hline
\textbf{Computing Resources}                                         & \textbf{Conventional Method} & \textbf{Proposed Method} & \textbf{Performance Ratio} \\ \hline
GPU Utilization (\%)                                                  & 65.61                        & 22.3                    & 0.34                       \\ \hline
CPU Utilization (\%)                                                  & 50.24                        & 34                    & 0.45                       \\ \hline
\begin{tabular}[c]{@{}c@{}}Download Throughput\\ (Kbps)\end{tabular} & 4028                         & 1478                  & 0.36                       \\ \hline
\end{tabular}
\end{table}
...
\hline
\textbf{Computing Resources}                                         & \textbf{Conventional Method} & \textbf{Proposed Method} & \textbf{Performance Ratio} \\ \hline
GPU Utilization (\%)                                                  & 65.61                        & 33.73                    & 0.33                       \\ \hline
CPU Utilization (\%)                                                  & 50.24                        & 25.9                     & 0.43                       \\ \hline
\begin{tabular}[c]{@{}c@{}}Download Throughput\\ (Kbps)\end{tabular} & 4028                         & 1808.2                   & 0.35                       \\ \hline
\end{tabular}
\end{table}
